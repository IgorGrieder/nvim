...
return {
  {
    ...
    opts = {
      setup = {
        -- desabilita a configuração jdtls do lspconfig
        jdtls = function()
          return true
        end,
      },
  ...
  },
  {
    ...
    config = function()
      ...
      -- obtém o caminho de instalação do mason
      local install_path = require("mason-registry").get_package("jdtls"):get_install_path()
      -- obtém o caminho de instalação do adaptador de depuração
      ...
      -- Comente estas linhas se você tiver 'java-test' instalado
